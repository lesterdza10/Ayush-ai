...
const doshaQuestions = [
  'Do you often feel cold or have dry skin?',
  'Are you naturally quick and creative?',
  'Do you have a strong, intense personality?',
  'Do you prefer warm, cozy environments?',
  'Do you get tired easily?',
  'Are you naturally calm and stable?',
  'Do you often experience bloating?',
  'Do you have a fast metabolism?',
  'Do you prefer sweet tastes?',
  'Are you naturally organized and disciplined?',
  'Do you have difficulty with irregular schedules?',
        ...
        return (
          ...
          >
            ...
            <FormInput
              ...
              placeholder="25"
              value={formData.age}
              onChange={(v) => handleInputChange('age', Number(v))}
            />
            <FormSelect
              label="Gender"
              options={[
            ...
            <FormInput
              ...
              onChange={(v) => handleInputChange('height', Number(v))}
            />
            <FormInput
              label="Weight (kg)"
              type="number"
              ...
              onChange={(v) => handleInputChange('weight', Number(v))}
            />
            <FormInput
              label="Location"
        ...
        return (
          ...
          >
            ...
            <FormSelect
              ...
              onChange={(v) => handleInputChange('appetite', v)}
            />
            <FormSelect
              label="Digestion"
              options={[
              ...
              onChange={(v) => handleInputChange('digestion', v)}
            />
            <FormSlider
              label="Sleep Quality"
              min={1}
        ...
        return (
          ...
          >
            ...
            <FormInput
              ...
              onChange={(v) => handleInputChange('wakeUpTime', v)}
            />
            <FormInput
              label="Usual Sleep Time"
              type="time"
              value={formData.sleepTime}
              onChange={(v) => handleInputChange('sleepTime', v)}
            />
            <FormSelect
            ...
            <FormSelect
              ...
              onChange={(v) => handleInputChange('foodType', v)}
            />
            <FormSelect
              ...
              onChange={(v) => handleInputChange('junkFoodFreq', v)}
            />
            <FormInput
              ...
              onChange={(v) => handleInputChange('waterIntake', Number(v))}
            />
          </motion.div>
        );
      ...
      case 3:
        return (
          ...
          >
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">Answer these questions to understand your Ayurvedic constitution.</p>
            <div className="space-y-4 max-h-96 overflow-y-auto pr-4">
              {doshaQuestions.map((question, index) => (
                <div
                  key={index}
                  className="backdrop-blur-md bg-white dark:bg-slate-700 rounded-xl border border-cyan-300 dark:border-cyan-600 p-4 flex items-center gap-4 hover:bg-cyan-50 dark:hover:bg-slate-600 transition-all"
                >
                  <div className="flex gap-2">
                    <button
                      onClick={() => handleDoshaAnswer(index, true)}
                      className={`
                        px-4 py-2 rounded-lg font-semibold transition-all
                        ${
                          formData.doshaAnswers[index]
                    ...
                    <button
                      onClick={() => handleDoshaAnswer(index, false)}
                      className={`
                        px-4 py-2 rounded-lg font-semibold transition-all
                        ${
                          !formData.doshaAnswers[index]
        ...
        {showRecommendations ? (
          ...
          <>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400">Create your personalized health profile in 4 simple steps</p>
            </motion.div>
